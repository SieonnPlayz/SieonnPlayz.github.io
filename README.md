...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="description" content="The first java client recoded to bedrock.. Novoline Client. Novoline Bedrock Inculdes is a hack client which has vErY vErRyY gOod bypasses From the original Novoline client from java all just recoded to bedrock....">
    <!-- Fonts -->
    ...
    <div class="header_row">
        ...
        <div class="header_menu">
            <ul class="menu">
                ...
                <li>
                    <a href="https://discord.gg/wjRYjVWkya">contact</a>
                </li>
            </ul>
        </div>
        ...
        <div class="container">
            ...
            <div class="mb_btns">
                <a href="https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/loadstring" class="blue_btn">script</a>
                <a href="https://cdn.discordapp.com/attachments/890402400555372595/947704071190618202/Vape_Lite_Roblox.exe" class="blue_btn">Vape Lite</a>
            ...
            <div class="footer_menu">
                <div class="footer_menu_main">
                    <ul>
                        ...
                        <li>
                            <a class="fm_left underline_blue" href="https://discord.gg/wjRYjVWkya">Contact</a>
                        </li>
                    </ul>
                </div>
